...
public final class FragmentSecondBinding implements ViewBinding {
  ...
  @NonNull
  public final EditText showResponse;
  ...
  private FragmentSecondBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonSecond,
      @NonNull EditText editTextTextPersonName, @NonNull EditText showResponse,
      @NonNull TextView textView, @NonNull TextView textviewSecond) {
  ...
  public static FragmentSecondBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.showResponse;
      EditText showResponse = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentSecondBinding((ConstraintLayout) rootView, buttonSecond,
          editTextTextPersonName, showResponse, textView, textviewSecond);
    }
